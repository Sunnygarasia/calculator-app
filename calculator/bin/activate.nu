...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/Users/shalingarasia/Python Projects/Calculator/Calculator'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/Users/shalingarasia/Python Projects/Calculator/Calculator/bin/deactivate.nu'
